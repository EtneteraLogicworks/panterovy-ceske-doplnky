...
/usr/libexec/PlistBuddy -c "Add com.apple.DictionaryServices:DCSActiveDictionaries:1 string '/Library/Dictionaries/Slovník Hantecu.dictionary'" ~/Library/Preferences/.GlobalPreferences.plist
/usr/libexec/PlistBuddy -c "Add com.apple.DictionaryServices:DCSActiveDictionaries:2 string '/System/Library/Frameworks/CoreServices.framework/Frameworks/DictionaryServices.framework/Resources/Wikipedia.wikipediadictionary'" ~/Library/Preferences/.GlobalPreferences.plist
/usr/libexec/PlistBuddy -c "Add com.apple.DictionaryServices:DCSActiveDictionaries:3 string '/Library/Dictionaries/Apple Dictionary.dictionary'" ~/Library/Preferences/.GlobalPreferences.plist
